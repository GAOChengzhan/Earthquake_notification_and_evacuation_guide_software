...
namespace 前台
{
    ...
    public partial class Form4 : Form
    {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            string search = "select F1 as 时间,F2 as 震级,F3 as 纬度,F4 as 经度,F5 as 震源深度,F6 as 参考位置 from earthquake_data where F1 like '%" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "%'";
        ...
        private void dateTimePicker2_ValueChanged(object sender, EventArgs e)
        {
            ...
            SqlConnection mycon = new SqlConnection(earthquake);
            string search = "select F1 as 时间,F2 as 震级,F3 as 纬度,F4 as 经度,F5 as 震源深度,F6 as 参考位置 from earthquake_data where F1 like '%" + dateTimePicker2.Value.ToString("yyyy-MM") + "%'";
